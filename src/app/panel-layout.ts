    ...
    setTrustedHtml(this.ctx.container, trustedHtml(`
      ...
      <nav class="mobile-menu" id="mobileMenu" aria-label="Menu">
        ...
        <div class="mobile-menu-footer-links">
          ...
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/blog/' : '/blog'}" target="_blank" rel="noopener">Blog</a>
          <a href="${this.ctx.isDesktopApp ? 'https://worldmonitor.app/docs' : '/docs'}" target="_blank" rel="noopener">Docs</a>
        </div>
